...
$$ IC = [\bar{x} - t_{\alpha} * {\frac{s}{\sqrt{n}}} ; \bar{x} + t_{\alpha} * {\frac{s}{\sqrt{n}}} ] $$
Ici : 

- $\bar{x}$ correspond à la moyenne. 
- $t_{\alpha}$ la valeur du coefficient de Student pour l'intervalle de confiance à 95%, soit $t_{95}$. Se calcule avec la fonction `qt()`.
- $s$ l'écart-type. 
