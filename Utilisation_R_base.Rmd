...
```{r}
setwd("C:/Users/camil/Camille/1_These/5_Monitorat/2A/Eco_fonctio_L2")
```
...
⚠️ **Correlation n'est pas causalité! **
...
<br>
```{r}
hist(data$poids_sec_av, col = "aquamarine3", main = "Fréquences des masses sèches avant", xlab = "masses sèches (en g)", ylab = "Fréquence")
```
<br>
...
```{r}
boxplot(data$conso_masse ~ data$espece, col = "aquamarine3", main = "Consommation en fonction des espèces", xlab = "espèces", ylab = "Concommation par unité de masse")
```
<br>
